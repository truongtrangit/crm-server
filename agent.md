...
11. **Backend Controller & Service Convention**: 
    ...
    - **Cách Export Service**: Định nghĩa các method dưới dạng biến/arrow function độc lập (`const doLogic = async () => {}`), sau đó export thành object tổng ở cuối file (`module.exports = { doLogic };`). KHÔNG khởi tạo 1 object khổng lồ từ đầu file rồi nhét function vào.
