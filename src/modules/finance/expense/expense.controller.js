...
class ExpenseController {
  ...
  async createCategory(req, res) {
    ...
    const category = await expenseService.createCategory(value);
  ...
  async updateCategory(req, res) {
    ...
    const { category, changes } = await expenseService.updateCategory(
      req.params.id,
      value,
    );
    SystemLogService.log({
  ...
  async getExpectedExpenses(req, res) {
    ...
    return sendSuccess(
      res,
      200,
      'Lấy danh sách chi phí dự kiến thành công',
      result,
    );
  }
  ...
  async updateExpectedExpense(req, res) {
    ...
    const { expected, changes } = await expenseService.updateExpectedExpense(
      req.params.id,
      req.body,
      force,
    );
    ...
    return sendSuccess(
      res,
      200,
      'Cập nhật chi phí dự kiến thành công',
      expected,
    );
  }
  ...
  async deleteExpectedExpense(req, res) {
    const force = req.query.force === 'true';
    const expected = await expenseService.deleteExpectedExpense(
      req.params.id,
      force,
    );
    SystemLogService.log({
  ...
  async updateExpense(req, res) {
    const { expense, changes } = await expenseService.updateExpense(
      req.params.id,
      req.body,
    );
    SystemLogService.log({
