...
const bankLogTransactionSchema = new mongoose.Schema(
  {
    ...
    bankTxCode: { type: String, default: null, trim: true },
    ...
    transactionChannel: {
      ...
      default: null,
      trim: true,
      // Removed enum — ACB can introduce new channels anytime (e.g. DRCT)
      // Joi validation handles the required check at ingestion
    },
    ...
    acbRequestCode: {
      type: String,
      enum: ['TRANSACTION_UPDATE', 'TRANSACTION_HISTORY'],
      default: null,
    },
    acbTransactionStatus: {
      type: String,
      enum: ['COMPLETED', 'ERRORCORRECTED'],
      default: null,
    },
