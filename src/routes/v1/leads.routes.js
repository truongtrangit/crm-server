...
const LeadController = require('../../modules/lead/lead/lead.controller');
...
const { leadResourceAccess, leadAssignmentRules, leadUnassignmentRules, leadScopeList } = require('../../core/middleware/leadAccess');
