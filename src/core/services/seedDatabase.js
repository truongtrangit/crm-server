...
const Event = require('../../modules/event/event/event.model');
const Organization = require('../../modules/hr/organization/organization.model');
const User = require('../../modules/system/user/user.model');
const StaffFunction = require('../../modules/hr/function/staffFunction.model');

const Action = require('../../modules/event/actionConfig/action.model');
const Result = require('../../modules/system/metadata/result.model');
const Reason = require('../../modules/system/metadata/reason.model');
const ActionChain = require('../../modules/event/eventActionChain/actionChain.model');
const Counter = require('../models/Counter');
const MetaConfig = require('../../modules/system/meta/metaConfig.model');
const MetaProgram = require('../../modules/system/meta/metaProgram.model');
...
async function seedDatabase() {
  ...
  const JobConfigTaskType = require('../../modules/job/jobConfig/jobConfigTaskType.model');
