  ...
  const programsData = [
    {
      ...
      progressPercent: 90,
      tasks: [
        { title: 'Setup Meta Business Suite', picId: 'USER4', picName: 'Vũ Thu Phương', deadline: new Date('2025-01-10'), isCompleted: true, completedAt: new Date('2025-01-08') },
        { title: 'Chạy A/B test creative tháng 1', picId: 'USER4', picName: 'Vũ Thu Phương', deadline: new Date('2025-01-31'), isCompleted: true, completedAt: new Date('2025-01-28') },
        { title: 'Báo cáo mid-term Q1', picId: 'USER4', picName: 'Vũ Thu Phương', deadline: new Date('2025-02-15'), isCompleted: true, completedAt: new Date('2025-02-14') },
        { title: 'Tối ưu retargeting campaign', picId: 'USER4', picName: 'Vũ Thu Phương', deadline: new Date('2025-03-15'), isCompleted: true, completedAt: new Date('2025-03-12') },
        { title: 'Tổng kết Q1 & báo cáo cuối kỳ', picId: 'USER4', picName: 'Vũ Thu Phương', deadline: new Date('2025-03-31'), isCompleted: false, completedAt: null },
      ],
      milestones: [
    ...
    },
    {
      ...
      progressPercent: 35,
      tasks: [
        { title: 'Đăng ký Whatsapp Business API', picId: 'USER5', picName: 'Lê Văn Hùng', deadline: new Date('2025-02-28'), isCompleted: true, completedAt: new Date('2025-02-25') },
        { title: 'Setup webhook & server endpoint', picId: 'USER5', picName: 'Lê Văn Hùng', deadline: new Date('2025-03-15'), isCompleted: true, completedAt: new Date('2025-03-10') },
        { title: 'Xây dựng chatbot flow cơ bản', picId: 'USER5', picName: 'Lê Văn Hùng', deadline: new Date('2025-04-15'), isCompleted: false, completedAt: null },
        { title: 'Triển khai cho 5 khách hàng pilot', picId: 'USER5', picName: 'Lê Văn Hùng', deadline: new Date('2025-05-15'), isCompleted: false, completedAt: null },
        { title: 'Mở rộng đến 10 khách hàng', picId: 'USER5', picName: 'Lê Văn Hùng', deadline: new Date('2025-06-15'), isCompleted: false, completedAt: null },
      ],
      milestones: [
    ...
    },
    {
      ...
      progressPercent: 25,
      tasks: [
        { title: 'Phân tích dữ liệu đơn hàng Q1', picId: 'USER7', picName: 'Trần Đức Anh', deadline: new Date('2025-04-10'), isCompleted: true, completedAt: new Date('2025-04-09') },
        { title: 'Setup tracking & attribution', picId: 'USER7', picName: 'Trần Đức Anh', deadline: new Date('2025-04-20'), isCompleted: true, completedAt: new Date('2025-04-18') },
        { title: 'Launch campaign phase 1', picId: 'USER7', picName: 'Trần Đức Anh', deadline: new Date('2025-05-01'), isCompleted: false, completedAt: null },
        { title: 'Scale budget nếu CPO < $1', picId: 'USER7', picName: 'Trần Đức Anh', deadline: new Date('2025-05-30'), isCompleted: false, completedAt: null },
      ],
      milestones: [
    ...
    },
    {
      ...
      progressPercent: 60,
      tasks: [
        { title: 'Tạo Lookalike Audience', picId: 'USER8', picName: 'Hoàng Diệu Linh', deadline: new Date('2025-03-10'), isCompleted: true, completedAt: new Date('2025-03-08') },
        { title: 'Setup Messenger auto-reply', picId: 'USER8', picName: 'Hoàng Diệu Linh', deadline: new Date('2025-03-20'), isCompleted: true, completedAt: new Date('2025-03-18') },
        { title: 'Launch CTX campaign', picId: 'USER8', picName: 'Hoàng Diệu Linh', deadline: new Date('2025-04-01'), isCompleted: true, completedAt: new Date('2025-03-30') },
        { title: 'Tích hợp tracking vào CRM', picId: 'USER8', picName: 'Hoàng Diệu Linh', deadline: new Date('2025-04-15'), isCompleted: false, completedAt: null },
        { title: 'Báo cáo tổng kết chiến dịch', picId: 'USER8', picName: 'Hoàng Diệu Linh', deadline: new Date('2025-05-25'), isCompleted: false, completedAt: null },
      ],
      milestones: [
